...
urlpatterns = [
    ...
    path('search?q=link+for+django+admin&oq=link+for+django+mentor&aqs=chrome..69i57j0i22i30i457.7240j1j4&sourceid=chrome&ie=UTF-8/', views.updatedindex, name='updatedindex'),
    ...
    path('api/update-join-status', views.UpdateJoinStatusView.as_view(), name='update_join_status'),
]
