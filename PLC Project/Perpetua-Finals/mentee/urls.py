...
urlpatterns = [
    ...
    path('search?q=link+for+django+admin&oq=link+for+django+mentor&aqs=chrome..69i57j0i22i30i457.7240j1j4&sourceid=chrome&ie=UTF-8/', views.studindex, name='studindex'),
    ...
    path('api/join-class', views.JoinClassView.as_view(), name='join_class'),
]
